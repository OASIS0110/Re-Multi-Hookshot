<div align="center">
	<a href="https://github.com/OASIS0110/Re-Multi-Hookshot">
		<img alt="hookshot icon" src="pack_icon.png">
	</a>
</div>
...
- 前作、90%コマンド式であった『Multi Hookshot』をScript API(Java Script)を用いて0から書き直し、様々なバグを修正、改善した。
...
- Script API(Java Script)による改善
 ...
 - 完全マルチ対応
	- 完全なマルチプレイが対応ではなかった部分を、完全マルチプレイに対応。数十人でも数百人でも、パソコンが耐えうる限りマルチでフックショットが使えます。

<h1 align="center">変更履歴</h1></br>
